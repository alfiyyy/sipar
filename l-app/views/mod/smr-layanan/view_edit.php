	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="text" name="smrl_nama" value="<?=$data_row['smrl_nama'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Smrl Nama -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="number" name="smrl_harga" value="<?=$data_row['smrl_harga'];?>" class="form-control" required />
				</div>
			</div>
			<!--/ input number | Smrl Harga -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:250px;">
						<input id="time-picker" type="text" name="created_at" value="<?=$data_row['created_at'];?>" class="form-control" placeholder="HH:ii:ss" required/>
