...
$(function() {
	...
	$('.delete_gambar_class').on('click',function(e) {
		e.preventDefault();
		var dataPk = [$(this).attr('data-id')];
		var dataUrl = admin_url + a_mod + '/delete_gambar_class/class';
		_deleteGambarClass(dataPk,dataUrl)
	});

	function _deleteGambarClass(pk,uri){
		var dataPk = pk;
		var dataUrl = uri;
						...
						$.ajax({
							...
							success:function(response) {
								if (response['success']==true) {
									$('#class-item'+response['dataDelete']).remove();
									resolve();					
								}
								else {
									Swal({
	...
	$('.delete_gallery_class').on('click',function(e) {
		e.preventDefault();
		var dataPk = [$(this).attr('data-id')];
		var dataUrl = admin_url + a_mod + '/delete_gallery_class/gallery';
		_deleteGalleryClass(dataPk,dataUrl)
	});

	function _deleteGalleryClass(pk,uri){
		var dataPk = pk;
		var dataUrl = uri;
		getLangJSON().done(function(lang){
			swal({
	...
	$('.delete_fasilitas_class').on('click',function(e) {
		e.preventDefault();
		var dataPk = [$(this).attr('data-id')];
		var dataUrl = admin_url + a_mod + '/delete_fasilitas_class/fasilitas';
		_deleteFasilitasClass(dataPk,dataUrl)
	});

	function _deleteFasilitasClass(pk,uri){
		var dataPk = pk;
		var dataUrl = uri;
		getLangJSON().done(function(lang){
			swal({
	...
	$('.delete_layanan_class').on('click',function(e) {
		e.preventDefault();
		var dataPk = [$(this).attr('data-id')];
		var dataUrl = admin_url + a_mod + '/delete_layanan_class/layanan';
		_deleteLayananClass(dataPk,dataUrl)
	});

	function _deleteLayananClass(pk,uri){
		var dataPk = pk;
		var dataUrl = uri;
		getLangJSON().done(function(lang){
			swal({
