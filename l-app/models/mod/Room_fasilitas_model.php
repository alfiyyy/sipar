...
class Room_fasilitas_model extends CI_Model {

	public $vars;
	private $_table = 't_room_fasilitas';
	private $_column_order = array(null, 'rf_id', 'rf_nama', 'rf_icon', 'rf_id');
	private $_column_search = array('rf_id', 'rf_nama', 'rf_icon', 'rf_id');
	...
	*/
	...
	public function delete($val = 0)
	{
		...
		{
			$this->db->where('rf_id', $val)->delete($this->_table);
			return TRUE;
		}
		else
		{
	...
	{
		$query = $this->db->where('rf_id', $val_id);
