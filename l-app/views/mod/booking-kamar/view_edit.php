...
<div class="page-inner">
	<div class="d-sm-flex align-items-center justify-content-between pd-b-20">
		...
		<div class="mg-t-15">
			<button type="button" class="btn btn-md pd-x-15 btn-white btn-uppercase" onclick="window.location='<?=admin_url($this->mod.'/riwayat');?>'"><i data-feather="arrow-left" class="mr-2"></i><?=lang_line('button_back');?></button>
		</div>
	</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:250px;">
						<input id="date-picker" type="text" name="br_tanggal_in" value="<?=$data_row['br_tanggal_in'];?>" class="form-control" placeholder="yyyy-mm-dd" required/>
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:400px;">
						...
						<input id="prv" type="text" value="<?=$data_row['br_dokumen'];?>" class="form-control" placeholder="Choose file..." readonly />
					</div>
					<input id="pictures" type="hidden" name="br_dokumen" value="<?=$data_row['br_dokumen'];?>" class="form-control" />
				</div>
			</div>
			<!-- input browse filemanager | Dokumen -->
