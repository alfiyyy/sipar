...
<div class="page-inner">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<!--/ input number | Unker Id -->
			<!-- input text | Smrf Nama -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Smrf Nama</label>
				<div class="col-md-10">
					<input type="text" name="smrf_nama"  class="form-control" />
				</div>
			</div>
			<!--/ input text | Smrf Nama -->
			<!-- input text | Smrf Icon -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Smrf Icon</label>
				<div class="col-md-10">
					<input type="text" name="smrf_icon"  class="form-control" />
				</div>
			</div>
			<!--/ input text | Smrf Icon -->
