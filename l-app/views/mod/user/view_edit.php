			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-3">
					<div class="form-group">
						...
						<input type="hidden" name="username" class="form-control" value="<?=$res_user['username'];?>" />
					</div>
				</div>
				<!--/ Username -->
				...
				<?php if ($res_user['status_terima'] == null) { ?>
					<!-- Status Accept -->
					<div class="col-md-6 col-lg-2">
						<div class="form-group">
							<label>Verifikasi</label>
							<select class="select-bs form-control" name="status_accept">
