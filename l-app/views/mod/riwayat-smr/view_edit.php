			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:250px;">
						<input id="date-picker" type="text" name="bs_tanggal_in" value="<?=$data_row['bs_tanggal_in'];?>" class="form-control" placeholder="yyyy-mm-dd" required/>
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:400px;">
						...
						<input id="prv" type="text" value="<?=$data_row['bs_dokumen'];?>" class="form-control" placeholder="Choose file..." readonly />
					</div>
					<input id="pictures" type="hidden" name="bs_dokumen" value="<?=$data_row['bs_dokumen'];?>" class="form-control" />
				</div>
			</div>
			<!-- input browse filemanager | Dokumen -->
