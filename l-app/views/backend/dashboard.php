		...
		<div  class="page-sidebar">
			<div class="logo">
				<a href="#" class="logo-img">
					...
					<span class="desktop-logo text-logo">
					<img class="" src="<?=content_url('themes/backend/images/logo-kecil.png');?>" alt="" />	
					SiPAR<span> PUPR</span></span>
					<img class="small-logo" src="<?=content_url('themes/backend/images/logo-kecil.png');?>" alt="" />	
			...
			<div class="page-sidebar-inner">
				<div class="page-sidebar-menu">
					<?php 
						...
						} elseif (data_login('key_group')=="peserta") {
							echo $this->CI->cifire_menu->dashboard_menu(
								$group_id = 5, 
								$ul_attr  = 'id="main-menu" class="accordion-menu"'
							);
							...
							<li class="top-link list-inline-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-profile">
									<div class="user-profile-area">
										...
										<a href="https://web.facebook.com/linux.squeez/" target="_blank" class="dropdown-item"><i data-feather="life-buoy" class="wd-16 mr-2"></i> <?=lang_line('menu_help_center');?></a>
