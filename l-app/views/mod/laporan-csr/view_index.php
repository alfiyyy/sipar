		...
		<div class="pageheader pd-t-20 pd-b-0">
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					...
					<h4 class="pd-0 mg-0 tx-20">Laporan Class Smart Room</h4>
				</div>
			</div>
		</div>
	</div>
					...
					<tbody>
                        ...
                        <tr>
                            ...
                            <?php for ($x=1; $x<=31; $x++) {
                                ...
                                $query1 = $this->db->select('*')->from('t_booking_csr');
                                $query1 = $this->db->where('csr_id', $row['csr_id']);
                                $query1 = $this->db->where('bc_tanggal_in', $tanggal_array);
                                $query1 = $this->db->get();  
