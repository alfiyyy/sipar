...
<div class="page-inner">
	...
	<div class="card">
		...
		<div class="card-body">
					...
					<select name="unker_id" class="select2 form-control" data-placeholder="Unit Kerja">
						<?php
							foreach ($all_unker as $unker) {
									$selected = ($unker['unker_id']==$data_row['unker_id']?'selected':'');
			...
			<div class="form-group row">
				<label class="col-form-label col-md-2">Kategori Nama</label>
				<div class="col-md-10">
					<input type="text" name="kategori_nama" value="<?=$data_row['kategori_nama'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Kategori Nama -->
			<!-- textarea TinyMCE | Kategori Deskripsi -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Kategori Deskripsi</label>
				<div class="col-md-10">
					<textarea id="textarea-tinymce" name="kategori_deskripsi" class="form-control"><?=$data_row['kategori_deskripsi'];?></textarea>
				</div>
			</div>
			<!--/ textarea TinyMCE | Kategori Deskripsi -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:400px;">
						...
						<input id="prv" type="text" value="<?=$data_row['kategori_image'];?>" class="form-control" placeholder="Choose file..." readonly />
					</div>
					<input id="pictures" type="hidden" name="kategori_image" value="<?=$data_row['kategori_image'];?>" class="form-control" />
				</div>
			</div>
			<!-- input browse filemanager | Kategori Image -->
