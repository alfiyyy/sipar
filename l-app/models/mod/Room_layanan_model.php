...
class Room_layanan_model extends CI_Model {

	public $vars;
	private $_table = 't_room_layanan';
	private $_column_order = array(null, 'rl_id', 'rl_nama', 'rl_harga', 'rl_id');
	private $_column_search = array('rl_id', 'rl_nama', 'rl_harga', 'rl_id');
	...
	*/
	...
	public function delete($val = 0)
	{
		...
		{
			$this->db->where('rl_id', $val)->delete($this->_table);
			return TRUE;
		}
		else
		{
	...
	{
		$query = $this->db->where('rl_id', $val_id);
