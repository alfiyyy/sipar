...
class Smr_gambar_model extends CI_Model {

	public $vars;
	private $_table = 't_smr_gambar';
	private $_column_order = array(null, 'smrg_id', 'smrg_image', 'smrg_id');
	private $_column_search = array('smrg_id', 'smrg_image', 'smrg_id');
	...
	*/
	...
	{
		$query = $this->db->where('smrg_id', $key);
	...
	public function delete($val = 0)
	{
		...
		{
			$this->db->where('smrg_id', $val)->delete($this->_table);
			return TRUE;
		}
		else
		{
	...
	{
		$query = $this->db->where('smrg_id', $val_id);
