...
class Room_gambar_model extends CI_Model {

	public $vars;
	private $_table = 't_room_gambar';
	private $_column_order = array(null, 'rg_id', 'rg_image', 'rg_id');
	private $_column_search = array('rg_id', 'rg_image', 'rg_id');
	...
	*/
	...
	public function delete($val = 0)
	{
		...
		{
			$this->db->where('rg_id', $val)->delete($this->_table);
			return TRUE;
		}
		else
		{
	...
	{
		$query = $this->db->where('rg_id', $val_id);
