...
<div class="page-inner p-settings mg-b-70">
			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
                    <div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item">Kelola Smar Meeting Room</a>
					</div>
	...
	<ul class="nav nav-tabs nav-justified" role="tablist">
		<li class="nav-item">
			<a href="#Tab-Kamar" class="nav-link tx-medium active" data-toggle="tab" style="color:#1b2e4b;">Smart Meeting</a>
		</li>
		<li class="nav-item">
							...
							<div class="row">
								...
								<div id="meeting-item<?=$row->smr_id;?>" class="col-sm-6 col-md-4 mb-4">
									<div class="card card-body">
										...
										<div class="media">
											<a href="?edit=yes&smr_id=<?= $row->smr_id ?>"><div class="wd-40 wd-md-50 ht-40 ht-md-50 bg-success tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded"><i class="fa fa-bed"></i></div></a>
					...
					<div class="col-md-4">
                        <div class="card">
                            <div class="card-header bg-success">
                                <h6 class="lh-5 mg-b-0 text-white">Edit SMR</h6>
                            </div>
                            <?php 
								$queryRID = $this->db->where('smr_id', $rid)->get('t_smr');
                            ...
                            ?>
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <label>Nama SMR</label>
                                        <input type="hidden" name="unker_id"  class="form-control" value="<?= $unker_id ?>" />
										<input type="hidden" name="smr_id"  class="form-control" value="<?= $resultRID->smr_id ?>" />
                                        <input type="text" name="smr_nama" value="<?= $resultRID->smr_nama ?>"  class="form-control" />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Nomor SMR</label>
										<input type="text" name="smr_nomor" value="<?= $resultRID->smr_nomor ?>" class="form-control" />
                                    </div>
									<div class="form-group mb-3">
                                        <label>Kapasitas Orang</label>
										<input type="text" name="smr_kapasitas" value="<?= $resultRID->smr_kapasitas ?>" class="form-control" />
                                    </div>
                                </div>
					...
					<div class="col-md-4">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h6 class="lh-5 mg-b-0 text-white">Tambah SMR</h6>
                            </div>
                            <?php 
                                echo form_open('','autocomplete="off" class="form-bordered"');
                            ...
                            ?>
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <label>Nama SMR</label>
                                        <input type="hidden" name="unker_id"  class="form-control" value="<?= $unker_id ?>" />
                                        <input type="text" name="smr_nama"  class="form-control" />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Nomor SMR</label>
										<input type="text" name="smr_nomor"  class="form-control" />
                                    </div>
									<div class="form-group mb-3">
                                        <label>Kapasitas Orang</label>
										<input type="text" name="smr_kapasitas"  class="form-control" />
                                    </div>
                                </div>
                                <div class="card-footer">
						...
						<div class="box-body">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover mb-0">
									...
									<tr id="fasilitas-item<?=$row->smrf_id;?>">
										<td><?= $no ?></td>
										<td><i class="fa fa-<?= $row->smrf_icon ?>"></i></td>
										<td><?= $row->smrf_nama ?></td>
										<td><button class="btn btn-xs btn-danger delete_fasilitas_meeting" data-id="<?=encrypt($row->smrf_id);?>"><i class="cificon licon-trash-2"></i></button></td>
									</tr>
									<?php $no++; } ?>
								</table>
							</div>
                            ...
                            ?>
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="hidden" name="unker_id"  class="form-control" value="<?= $unker_id ?>" />
                                        <input type="text" name="smrf_nama"  class="form-control" />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Icon</label>
										<select name="smrf_icon" class="select2 form-control" style="max-width:400px;" required>
									...
									<div id="gallery-item<?=$res['smrg_id'];?>" class="col-sm-6 col-md-4 col-lg-3 mt-3 gbhs">
										<div class="card item-gal">
											<div class="pd-6 text-center">
												...
												<div class="btn-group mt-1 gbhs2" style="">
													<button class="btn btn-xs btn-danger delete_gallery_meeting" data-id="<?=encrypt($res['smrg_id']);?>"><i class="fa fa-times"></i></button>
												</div> 
												<div class="theme-img-card mb-2">
													<a class="fancybox" data-fancybox-group="gallery" title="<?=$res['smrg_image'];?>" href="<?=$src_imgs;?>">
														<img src="<?=$thumb;?>" data-src="<?=$thumb;?>" class="lazy" style="width:100%;">
													</a>
												</div>
												<div><?=$res['smrg_image'];?></div>
											</div>
										</div>
									</div>
									<?php endforeach ?>
                                ...
                                <div class="card-body">
									<div class="form-group mb-3">
										...
										<div class="col-md-10">
											...
											<input id="pictures" type="hidden" name="smrg_image"  class="form-control" />
											<input type="hidden" name="unker_id"  class="form-control" value="<?= $unker_id ?>" />
										</div>
									</div>
                                </div>
						...
						<div class="box-body">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover mb-0">
									...
									<tr id="layanan-item<?=$row->smrl_id;?>">
										<td><?= $no ?></td>
										<td><?= $row->smrl_nama ?></td>
										<td><?= $row->smrl_harga ?></td>
										<td style="text-align: center; vertical-align: middle;"><button class="btn btn-lg btn-danger delete_layanan_meeting" data-id="<?=encrypt($row->smrl_id);?>"><i class="cificon licon-trash-2"></i></button></td>
									</tr>
									<?php $no++; } ?>
								</table>
							</div>
                        ...
                        <div class="card">
                            ...
                            ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Harga</label>
										<input type="text" name="smrl_harga"  class="form-control" />
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-lg btn-primary mr-2"><i class="cificon licon-send mr-2"></i><?=lang_line('button_submit');?></button>
