			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item">Booking Class Smart Room</a>
					</div>
					<h4 class="pd-0 mg-0 tx-20">Booking Class Smart Room</h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
	...
	<div class="card">
        <div class="card">
            <div class="card-header">
                <h6 class="lh-5 mg-b-0">Pencarian Booking Class Smart Room</h6>
            </div>
            <?php 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 mb-3">
                            <div class="card card-body">
                                <div class="media">
                                <a href="#" <?php if($warna=="danger")  {} elseif($warna=="success") { ?> onclick="onModalBookCsr(<?= $row['csr_id'] ?>)" <?php } else { } ?> data-toggle="modal"><div class="wd-40 wd-md-50 ht-40 ht-md-50 bg-<?= $warna ?> tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded"><i class="fa fa-graduation-cap"></i></div></a>
...
<div id="modal_booking" class="modal">
	<div class="modal-dialog">
		<div class="modal-content">
            <?=form_open_multipart('l-admin/pesan-kamar/addcsr');?>
			<div class="modal-header">
				<h5 class="modal-title">Booking Class Smart Room</h5>
