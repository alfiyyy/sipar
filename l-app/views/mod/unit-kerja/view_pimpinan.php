	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-form-label col-md-2">Assesmen Pimpinan ke User Pimpinan</label>
				<div class="col-md-10">
                    <select name="id_user" class="select2 form-control" data-placeholder="User Pimpinan">
						<?php
