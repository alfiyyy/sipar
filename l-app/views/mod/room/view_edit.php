...
<div class="page-inner">
			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item">Room</a>
						<a href="#" class="breadcrumb-item">Edit Data</a>
					</div>
					<h4 class="pd-0 mg-0 tx-20">Room</h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<!--/ input number | Kategori Id -->
			<!-- input text | Room Nama -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Room Nama</label>
				<div class="col-md-10">
					<input type="text" name="room_nama" value="<?=$data_row['room_nama'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Room Nama -->
			<!-- input text | Room Nomor -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Room Nomor</label>
				<div class="col-md-10">
					<input type="text" name="room_nomor" value="<?=$data_row['room_nomor'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Room Nomor -->
