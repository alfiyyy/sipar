...
class Dashboard extends Backend_Controller {
	...
	public function index()
	{
		...
		{
			$this->cifire_alert->set('ENV', 'default', lang_line('ui_environment_development_info').'<br/><small>SiPAR PUPR Version <a href="#" target="_blank" title="Build Version">'.$this->VERSION.'</a></small>',FALSE);
		}
