...
function onModalTambahPeserta(kategori_id) {
	...
	$('#kategori_show').html('<input type="hidden" name="kategori_id" id="kategori_id" value="'+kid+'" class="form-control" require />  <input type="hidden" name="aksi" value="smr" />');
}
