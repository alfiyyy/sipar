# SiPAR PUPR - Kementrian PUPR
SiPAR PUPR is a open source PHP web framework, using the CodeIgniter3 framework with an interesting concept and easy to use by anyone.
...
## Installation
- Download the SiPAR PUPR source code from github or from the official website.
- Extract the SiPAR.zip file in your web directory. Make sure the .htaccess file is copied correctly.
...
## Official Links
* GitHub         : https://github.com/suseno1988
* Facebook       : https://web.facebook.com/linux.squeez


## License
SiPAR PUPR is licensed under the MIT License.
