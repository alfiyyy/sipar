                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 mb-3">
                            <div class="card card-body">
                                <div class="media">
                                    <a href="#" <?php if($warna=="danger")  {} elseif($warna=="success") { ?> onclick="onModalBook(<?= $row['smr_id'] ?>)" <?php } else { ?> onclick="window.location='<?=admin_url('riwayat-smr');?>'" <?php } ?> data-toggle="modal"><div class="wd-40 wd-md-50 ht-40 ht-md-50 bg-<?= $warna ?> tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded"><i class="fa fa-bed"></i></div></a>
...
<div id="modal_booking" class="modal">
	<div class="modal-dialog">
		<div class="modal-content">
            <?=form_open('l-admin/booking-smr/add');?>
			...
			<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <input id="pictures" type="hidden" name="bs_dokumen"  class="form-control" />
                    </div>
                </div>
