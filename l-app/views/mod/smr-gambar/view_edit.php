...
<div class="page-inner">
			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item">SMR Gambar</a>
						<a href="#" class="breadcrumb-item">Edit Data</a>
					</div>
					<h4 class="pd-0 mg-0 tx-20">SMR Gambar</h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<!--/ input number | Unker Id -->
			<!-- input browse filemanager | Smrg Image -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Smrg Image</label>
				<div class="col-md-10">
					<div class="input-group" style="max-width:400px;">
						...
						<input id="prv" type="text" value="<?=$data_row['smrg_image'];?>" class="form-control" placeholder="Choose file..." readonly />
					</div>
					<input id="pictures" type="hidden" name="smrg_image" value="<?=$data_row['smrg_image'];?>" class="form-control" />
				</div>
			</div>
			<!-- input browse filemanager | Smrg Image -->
