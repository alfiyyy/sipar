	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="number" name="smr_nomor"  class="form-control" required />
				</div>
			</div>
			<!--/ input number | Smr Nomor -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:250px;">
						<input id="date-picker" type="text" name="created_at" value="<?=date('Y-m-d');?>" class="form-control" placeholder="yyyy-mm-dd" required/>
