...
class Booking_csr extends Backend_Controller {
	
	public $mod = 'booking-csr';
	public $mod_rowayat = 'riwayat-booking-csr';
			...
			if ($this->input->method() == 'post')
			{
				...
				if ($this->form_validation->run())
				{
					...
					$data_isert = array(
						...
						'bc_jml_hari' => xss_filter($this->input->post('bc_jml_hari')),
					...
					// die();
					// if ($this->booking_csr_model->insert($data_isert))
					// {
					// 	$this->cifire_alert->set($this->mod, 'info', 'Data has been successfully added');
