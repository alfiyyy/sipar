...
<!-- menampilkan gambar -->
<section id="talenta" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
			<h3 style="padding: 0;">Pusat Pengembang Talenta</h3>
		</div>
		<div class="image-container col-md-6">
			<?php
			foreach ($pusatPengembangTalenta as $res) :
			?>
				<div class="g-item">
...
<section id="PUPRMedan" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
		...
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Medan as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRPalembang" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
		...
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Palembang as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRJakarta" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
		...
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Jakarta as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRBandung" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
		...
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Bandung as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRSurabaya" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
			<h3 style="padding: 0;">Pusat Pengembangan Kompetensi Pekerjaan Umum dan Perumahan Rakyat Wilayah VI Surabaya</h3>
		</div>
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Surabaya as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRBanjarmasin" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
			<h3 style="padding: 0;">Pusat Pengembangan Kompetensi Pekerjaan Umum dan Perumahan Rakyat Wilayah VII Banjarmasin</h3>
		</div>
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Banjarmasin as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
...
<section id="PUPRMakassar" style="padding-top: 2rem;" class="section-container">
	<div class="card-container row d-flex align-items-center">
		<div class="col-md-6 p-3 text-center">
			<h3 style="padding: 0;">Pusat Pengembangan Kompetensi Pekerjaan Umum dan Perumahan Rakyat Wilayah VIII Makassar</h3>
		</div>
		<div class="image-container col-md-6">
			<?php
			foreach ($balaiPegembanganKompetensiPUPR_Makassar as $res) :
			?>
				<div class="g-item">
					<a class="g-link" href="<?= post_images($res['image']) ?>" data-caption="<?= '<small><em>Smart Meeting Room : ' . $res['nama'] . '</em></small>' ?>" data-width="1200" data-height="900">
						<img class="p-2" height="200" src="<?= post_images($res['image'], 'medium', true) ?>" itemprop="thumbnail" alt="<?= $res['nama'] ?>" />
